...
//
//	public static final String TABLE_NAME = "abbrevations";
//    public static final String KEY_PHRASE = "phrase";
//    public static final String KEY_ABBR = "abbr";
//    public static final String KEY_ROWID = "_id";
//    
//    private static final String DATABASE_NAME = "smsreducer";
...
//        + "phrase text not null, body abbr not null);";
//
//
//
...
//     */
//    public AbbrDbAdapter(Context ctx) {
//        this.mCtx = ctx;
//    }
//
//    /**
...
//     * 
//     * @param pharase the title of the note
//     * @param abbr the body of the note
//     * @return rowId or -1 if failed
//     */
//    public long createLink(String pharase, String abbr) {
//        ContentValues initialValues = new ContentValues();
//        initialValues.put(KEY_PHRASE, pharase);
...
//
//        return mDb.query(TABLE_NAME, new String[] {KEY_ROWID, KEY_PHRASE,KEY_ABBR}, null, null, null, null, null);
//    }
//
//    /**
...
//                    KEY_PHRASE, KEY_ABBR}, KEY_ROWID + "=" + rowId, null,
//                    null, null, null, null);
//        if (mCursor != null) {
//            mCursor.moveToFirst();
//        }
